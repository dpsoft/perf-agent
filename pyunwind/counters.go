...
const (
	...
	PyCntPushRefused = 7
	// PyCntNoneExecutable: f_executable was NULL or Py_None -- the top
	// C-entered frame on CPython >= 3.13. A normal stop, counted so its
	// absence is as visible as its presence.
