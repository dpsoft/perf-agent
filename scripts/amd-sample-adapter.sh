...
Relevant env:
  ...
  - PERF_AGENT_AMD_SAMPLE_REAL_SOURCE
  - PERF_AGENT_ROCM_SMI_PATH
  - PERF_AGENT_ROCPROFV3_PATH
  - PERF_AGENT_ROCPROFV3_COMMAND
  - PERF_AGENT_ROCPROFV3_OUTPUT_PATH
  - PERF_AGENT_ROCPROFV3_OUTPUT_DIR
  - PERF_AGENT_ROCPROFILER_SDK_PATH
  - PERF_AGENT_ROCPROFILER_SDK_COMMAND
  - PERF_AGENT_ROCPROFILER_SDK_OUTPUT_PATH
  - PERF_AGENT_ROCPROFILER_SDK_OUTPUT_DIR
  - PERF_AGENT_AMD_SAMPLE_REAL_POLL_INTERVAL
EOF
}
